...
void lsCrashReport_DLG::_CreateControls()
{
    ...
    m_staticText31 = new wxStaticText(this, wxID_ANY,
                                      _("Please send us this error report to help fix the problem and improve this software"),
