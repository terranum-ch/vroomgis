...
IF (APPLE)
	...
	IF(DEBUG_PATH)
		...
		IF (SEARCH_GEOS)
	       ...
	       COMMAND install_name_tool  ARGS -change ${SEARCH_GIS_LIB_PATH}/lib/libgeos_c.${GEOS_C_VERSION}.dylib @executable_path/../${LIBNAME}/libgeos_c.${GEOS_C_VERSION}.dylib ${BUNDLEPATH}/Contents/MacOS/${CMAKE_PROJECT_NAME}
		...
		#copy proj lib
		EXEC_PROGRAM( "cp ${SEARCH_GIS_LIB_PATH}/lib/libproj.${PROJ_VERSION}.dylib ${BUNDLELIBPATH}")
		...
		EXEC_PROGRAM("install_name_tool -id  @executable_path/../${LIBNAME}/libproj.${PROJ_VERSION}.dylib ${BUNDLELIBPATH}/libproj.${PROJ_VERSION}.dylib") 
 		EXEC_PROGRAM("install_name_tool -change ${SEARCH_GIS_LIB_PATH}/lib/libproj.0.dylib @executable_path/../${LIBNAME}/libproj.${PROJ_VERSION}.dylib ${BUNDLELIBPATH}/libgdal.1.dylib")
