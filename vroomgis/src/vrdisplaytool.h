...
enum vrMOUSE_STATUS
{
    vrMOUSE_UNKNOWN = -1, vrMOUSE_UP = 0, vrMOUSE_DOWN, vrMOUSE_MOVE,
};
...
public:
    ...
    vrDisplayToolMessage(const wxEventType &eventtype, vrViewerDisplay *parent, const wxRect &rect,
                         vrMOUSE_STATUS mousestat = vrMOUSE_UNKNOWN);

    vrDisplayToolMessage(const wxEventType &eventtype, vrViewerDisplay *parent, const wxPoint &pos,
                         vrMOUSE_STATUS mousestat = vrMOUSE_UNKNOWN);
...
@date 27 avril 2011
*******************************************************************************/
class vrDisplayToolZoomOut
        : public vrDisplayToolZoom
{
public:
...
@date 30 mars 2012
*****************************************************************************************/
class vrDisplayToolEditLine
        : public vrDisplayToolEdit
{
private:
