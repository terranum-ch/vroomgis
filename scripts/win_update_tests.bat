...
echo %WXWIN%
cmake %trunkdir%\test\build %trunkdir%\test\build -G "Visual Studio 9 2008" -DCXXTEST_DIRECTORY:PATH=%PARAMCXX% -DSEARCH_GDAL:BOOL=1 -DSEARCH_GEOS:BOOL=1 -DSEARCH_GIS_LIB_PATH:PATH=%PARAMGIS% -DSEARCH_GEOS_LIB_PATH:PATH=%PARAMGEOS% -DUSE_MT_LIBRARY:BOOL=1 -DUNIT_TESTING_PATH:PATH=%UNIT_TESTING_PATH% -DSQLITE_PATH:PATH=%PARAMSQLITE%
