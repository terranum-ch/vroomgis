...
vrDisplayValueDlg::vrDisplayValueDlg(wxWindow * parent, vrViewerLayerManager * viewerlayermanager,
									 wxWindowID id,
...
void vrDisplayValueDlg::UpdateValues(const wxPoint & pos) {
	...
	if(m_LayerViewerManager->GetDispaly()->GetCoordinate()->ConvertFromPixels(pos,myCoord)==false){
