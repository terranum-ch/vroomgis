...
BEGIN_EVENT_TABLE(vroomTwinFrame, wxFrame)
                EVT_MENU(wxID_EXIT, vroomTwinFrame::OnQuit) EVT_MENU(wxID_ABOUT, vroomTwinFrame::OnAbout)
                EVT_MENU(wxID_OPEN, vroomTwinFrame::OnOpenLayer) EVT_MENU(wxID_REMOVE, vroomTwinFrame::OnCloseLayer)
                EVT_MENU (wxID_INFO, vroomTwinFrame::OnShowLog) EVT_MENU (wxID_ZOOM_IN, vroomTwinFrame::OnToolZoom)
                ...
                EVT_COMMAND(wxID_ANY, vrEVT_TOOL_SIGHT, vroomTwinFrame::OnToolAction) END_EVENT_TABLE()
