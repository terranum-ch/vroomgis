...
IF (APPLE)
	...
	FIND_PATH(DEBUG_PATH ${PROGNAME}
		"${PROJECT_BINARY_DIR}/Debug/${PROGNAME}.app/Contents/MacOS/"
		NO_DEFAULT_PATH)

	FIND_PATH(RELEASE_PATH ${PROGNAME}
		"${PROJECT_BINARY_DIR}/Release/${PROGNAME}.app/Contents/MacOS/"
		NO_DEFAULT_PATH)
		
		
	## DEBUG CONFIG
	IF(DEBUG_PATH)
		SET (BUNDLEPATH "${PROJECT_BINARY_DIR}/Debug/${PROGNAME}.app")
		SET (BUNDLELIBPATH "${BUNDLEPATH}/Contents/${LIBNAME}")
	...
	## RELEASE CONFIG
	IF(RELEASE_PATH)
		SET (BUNDLEPATH "${PROJECT_BINARY_DIR}/Release/${PROGNAME}.app")
		SET (BUNDLELIBPATH "${BUNDLEPATH}/Contents/${LIBNAME}")
